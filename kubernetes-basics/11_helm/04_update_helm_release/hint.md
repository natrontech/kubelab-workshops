**hint**: See all available values for the wordpress chart on the [bitnami helm chart documentation](https://github.com/bitnami/charts/tree/main/bitnami/wordpress).
